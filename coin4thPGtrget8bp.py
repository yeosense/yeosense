...
class Trade:
    def __init__(self):
        ...
        self.pGBuy_rsi = False
        self.pGSell_rsi = False
    ...
    def setTicker(self):
        ...
        self.get1stAmt()
        # set ticker
        print("set tr ticker :", self.ticker)
    ...
    def startTrading(self):
        ...
        while True:
            ...
            #print('p1_cci: ', p1_cci)
            #print('p0_cci: ', p0_cci)
            #print('self.pGBuy_cci: ', self.pGBuy_cci)
            #print('self.pGSell_cci: ', self.pGSell_cci)
            ...
            print("trade, pGBuy_rsi , pGBuy_cci , pGBuy_macd , pGBuy_ma  - ", self.trade, self.pGBuy_rsi , self.pGBuy_cci , pGBuy_macd , pGBuy_ma)
            print("trade, pGSell_rsi, pGSell_cci, pGSell_macd, pGSell_ma - ", self.trade, self.pGSell_rsi, self.pGSell_cci, pGSell_macd, pGSell_ma)
            ...
            if (self.trade == True and ( pGBuy_macd == True or pGBuy_ma == True)) or (self.pGBuy_rsi == True or self.pGBuy_cci == True ):
                # buy minute
            ...
            # set Sell timing
            #
            if (self.pGSell_rsi == True or self.pGSell_cci == True or pGSell_macd == True or pGSell_ma == True):
                # sell minute
            ...
            curTimeMinute = datetime.datetime.now().minute
            print(curTimeMinute)
            if curTimeMinute == 20 or curTimeMinute == 40 :
                self.setTicker()
            print()
            ################################################################################################################
